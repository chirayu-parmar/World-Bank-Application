...
/*
* This class is the second state on the Line Graph where 2 Line graph is displayed
*/
public class LineTwo implements LineState {
	/*
	...
	public ChartPanel getGraph(HashMap<String, HashMap<Integer, Double>> analysisResults, String fromDate,
		...
		// Plotting Data and return to graph
